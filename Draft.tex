...
\subsection{How effective is the training dataset?}
...
\begin{enumerate}
    ...
    \item Build the Radio Frequency Interference (RFI) classification feature discussed by \cite{tan} into \verb|PulsarClassifier|:
    
    According to \cite{tan}, by also including the classification category of RFI, the accuracy of the machine learning ensemble classifier was increased. The result of this feature would be three classifier output files: \verb|output.pulsars|, \verb|output.rfi|, and \verb|output.other|.
